namespace AmoozeshPJWinF
{
    partial class info
    {
        ...
        private void InitializeComponent()
        {
            ...
            label2.Location = new Point(128, 223);
            label2.Name = "label2";
            label2.Size = new Size(122, 25);
            label2.TabIndex = 1;
            label2.Text = "v1.0.f76f4e6";
            // 
            // label3
            // 
            ...
            label3.Location = new Point(47, 267);
            label3.Name = "label3";
            ...
            label4.Location = new Point(71, 310);
            label4.Name = "label4";
            ...
            label5.Location = new Point(38, 396);
            label5.Name = "label5";
            label5.Size = new Size(281, 23);
            label5.TabIndex = 4;
            label5.Text = "تمامی حقوق این اپلیکیشن برای سازندگان محفوظ میباشد";
            // 
            // pictureBox1
            // 
            pictureBox1.Location = new Point(121, 43);
